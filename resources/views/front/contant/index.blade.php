        ...
        <div class="col-lg-8">
          ...
          <form class="form-contact contact_form" action="{{ route('front.message.contact') }}" method="post" id="contactForm" >
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="email" id="email" type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" placeholder = 'Enter email address' value="{{ old('email') }}">
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
